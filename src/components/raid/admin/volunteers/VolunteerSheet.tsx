      ...
      <SheetContent side="team" className="flex flex-col gap-0 p-0">
        ...
        <ScrollArea className="h-[calc(100vh-220px)]">
          <div className="space-y-4 px-6 py-5">
            ...
            <Card className="border-border/70 shadow-sm">
              <CardHeader>
                <CardTitle className="text-base">{ts("emergency")}</CardTitle>
              </CardHeader>
              <CardContent>
                {!volunteer.emergency_person_name ||
                !volunteer.emergency_person_phone ? (
                  <p className="rounded-md border border-amber-200 bg-amber-50 p-3 text-sm text-amber-800 dark:border-amber-900/40 dark:bg-amber-950/40 dark:text-amber-300">
                    {ts("emergencyMissing")}
                  </p>
                ) : (
                  <>
