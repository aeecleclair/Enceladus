...
interface ProductsQuotaDialogProps {
  ...
  existingQuotas?: SchoolProductQuota[];
  title: string;
  description: string;
  submitLabel: string;
  isLoading: boolean;
...
export function ProductsQuotaDialog({
  isOpen,
  onOpenChange,
  onSubmit,
  onSubmitAll,
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogTrigger asChild>
        <Button className="flex items-center gap-2">
          <Plus className="h-4 w-4" /> Ajouter un quota pour ce produit
        </Button>
      </DialogTrigger>
      <DialogContent>
        <DialogHeader>
        ...
        <Form {...productQuotaForm}>
          <form
            onSubmit={productQuotaForm.handleSubmit((values) => {
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div className="text-sm text-amber-800">
                      ...
                      <p>
                        ...
                        pour ce produit et ne seront pas modifiées. Seules{" "}
